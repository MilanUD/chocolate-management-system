...
function getFactory(){
    axios.get(`http://localhost:8080/WebShopAppREST/rest/chocolateFactory/${user.value.factoryId}`).then(response => {
        factory.value = response.data;
        console.log('Grad je:', factory.value.location.address.city)
    })
}
