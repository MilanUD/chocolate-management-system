    ...
    <form @submit.prevent="registerUser">
      <div>
        ...
        <input
          ...
          name="username"
          type="text"
          v-model="userForRegistration.username"
        />
        <p class="text-danger" v-if="isUsernameTaken">
      ...
      <div>
        ...
        <input
          ...
          name="password"
          type="text"
          v-model="userForRegistration.password"
        />
      </div>
      <div>
      ...
      <div>
        ...
        <input
          ...
          id="name"
          name="name"
          v-model="userForRegistration.name"
        />
      </div>
      <div>
        ...
        <input
          ...
          id="lastName"
          name="lastName"
          v-model="userForRegistration.lastName"
        />
      </div>
      <div>
      ...
      <div>
        ...
        <input
          ...
          id="birthDate"
          name="birthDate"
          v-model="userForRegistration.birthDate"
        />
      </div>
      <div>
...
const doPasswordsMatch = computed(
  () => verifyPassword.value === userForRegistration.value.password
);
...
const isUsernameTaken = computed(() =>
  users.value.some((u) => u.username === userForRegistration.value.username)
);

function registerUser() {
  if (
    userForRegistration.value.username &&
    userForRegistration.value.password &&
    userForRegistration.value.name &&
    userForRegistration.value.lastName &&
    userForRegistration.value.gender &&
    userForRegistration.value.birthDate &&
