    ...
    <div class="card" v-for="chocolate in chocolates" :key="chocolate.id">
      <div class="card-body">
          ...
          <div class="col-md-2 d-flex flex-column">
            ...
            <div class="input-group">
              <button
                ...
                type="button"
                @click="decreaseQuantity(chocolate)"
              >
                -
              </button>
              <input
                ...
                class="form-control"
                id="quantity-input"
                v-model="chocolateCounts[chocolate.id]"
              />
              <button
                class="btn btn-outline-secondary"
                type="button"
        ...
        <div class="row mt-10">
          ...
          <div class="col-md-2 d-flex flex-column">
            <button
              @click="removeFromCart(chocolate)"
...
function makePurchase() {
  axios
    .post("http://localhost:8080/WebShopAppREST/rest/purchases/", cart.value)
    .then(() => {
      store.commit("clearCart");
    });
  axios
    .post(
      "http://localhost:8080/WebShopAppREST/rest/chocolates/updateQuantity",
      cart.value
    )
    .then(() => {
